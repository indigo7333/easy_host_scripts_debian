...
apt-get update
apt-get upgrade -y
apt-get -y install phpmyadmin mysql-server php5-mysql apache2 nginx  php5-intl php5-sqlite php5-gd procmail php5-cli php5-imap php5-curl rdiff-backup rsync
...
echo 'error_reporting = E_ALL & ~E_NOTICE & ~E_STRICT' >> /etc/php5/*/php.ini
